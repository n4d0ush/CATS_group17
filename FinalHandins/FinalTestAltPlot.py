...
roc_titles = ["RF, AUC = 0.94", "DT, AUC = 0.8", "LR, AUC = 0.96"]
...
axs[0,0].grid(color='gray', linestyle='--', linewidth=0.25)
axs[0,1].grid(color='gray', linestyle='--', linewidth=0.25)
axs[1,0].grid(color='gray', linestyle='--', linewidth=0.25)
axs[1,1].grid(False)
...
for i in range(len(y_proba_lst)):
    if i == 0:
        for j in range(len(ylabs)):
            ...
            axs[0,0].plot(curve_rf[0], curve_rf[1], label=f'AUC ({ylabs[j]}) = %0.2f' % auc_rf, linewidth=2.5)
            axs[0,0].plot([0, 1], [0, 1], color='gray', linestyle='--')
            axs[0,0].set_xlabel('FPR')
            axs[0,0].set_ylabel('TPR')
        axs[0,0].set_title(roc_titles[i])
        ...
        for j in range(len(ylabs)):
            ...
            axs[0, 1].plot(curve_rf[0], curve_rf[1], label=f'AUC ({ylabs[j]}) = %0.2f' % auc_rf, linewidth=2.5)
            axs[0, 1].plot([0, 1], [0, 1], color='gray', linestyle='--')
            axs[0, 1].set_xlabel('FPR')
            axs[0, 1].set_ylabel('TPR')
        axs[0,1].set_title(roc_titles[i])
        ...
        for j in range(len(ylabs)):
            ...
            axs[1, 0].plot(curve_rf[0], curve_rf[1], label=f'AUC ({ylabs[j]}) = %0.2f' % auc_rf, linewidth=2.5)
            axs[1, 0].plot([0, 1], [0, 1], color='gray', linestyle='--')
            axs[1, 0].set_xlabel('FPR')
            axs[1, 0].set_ylabel('TPR')
        axs[1,0].set_title(roc_titles[i])
...
cm.plot(ax=axs[1,1], cmap='Blues')

axs[1,1].set_title(f'RF, Accuracy = {rf_acc}')
